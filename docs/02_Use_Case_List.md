...
| Actor | Description |
|---|---|
| Customer | A user who browses flower products, manages cart, and places orders |
| Administrator | A user who manages products, customers, orders, and website content |
...
|---|---|---|
| UC-C01 | Register Account | Customer creates a new account |
| UC-C02 | Login | Customer authenticates into the system |
...
| Use Case ID | Use Case Name | Description |
|---|---|---|
| UC-A01 | Login | Administrator accesses management functions |
| UC-A02 | Manage Products | Administrator creates, updates, and deletes flower products |
| UC-A03 | Manage Categories | Administrator manages flower categories |
| UC-A04 | Manage Customers | Administrator manages customer information |
